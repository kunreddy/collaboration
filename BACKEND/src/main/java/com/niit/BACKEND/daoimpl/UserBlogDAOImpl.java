...
import com.niit.BACKEND.dao.UserBlogDAO;
import com.niit.BACKEND.model.UserBlog;



@EnableTransactionManagement//whether the transaction is occured (data is stored in database)
@Repository("userBlogDao") // when we go for database layer
